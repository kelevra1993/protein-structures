...
def main():
    ...
    parser.add_argument("--a3m_folder", type=str, required=True,
                        help="Path to the folder containing .a3m files.")
    parser.add_argument("--output_folder", type=str, required=True,
                        help="Path to save the generated output files (FASTA, TSV, JSONs).")
    parser.add_argument("--min_identity", type=float, default=0.4,
                        help="Minimum sequence identity threshold for clustering (default: 0.4).")
    parser.add_argument("--train_ratio", type=float, default=0.8,
                        help="Ratio of clusters to assign to the training set (default: 0.8).")
    ...
    split_data_by_clusters(cluster_mapping=cluster_mapping,
